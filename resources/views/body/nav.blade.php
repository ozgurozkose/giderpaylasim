...
<ul class="nav nav-pills nav-fill gap-3 p-2 medium bg-dark rounded-5 shadow-sm" id="pillNav2" role="tablist" style="--bs-nav-link-color: var(--bs-primary); --bs-nav-pills-link-active-color: var(--bs-primary); --bs-nav-pills-link-active-bg: var(--bs-warning);">
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link rounded-5" id="profile-tab2" data-bs-toggle="tab" type="button" role="tab" aria-selected="false">Referanslar</button>
  </li>
  <li class="nav-item" role="presentation">
    <button class="nav-link rounded-5" id="contact-tab2" data-bs-toggle="tab" type="button" role="tab" aria-selected="false">İletişim</button>
  </li>
  <div class="logo-container">
    ...
    <!-- <li>
        ...
        <a role="menuitem" href="/logout"><i class="bx bx-power-off"></i> Çıkış</a>
    </li> -->
</div>

    
    <div style="justify-content:center;" id="userbox" class="userbox">               
                <li>
                    <a style="justify-content:center; margin-right: 20px;" role="menuitem" href="/login"><i class="fa fa-person-booth"></i> Giriş</a>
                    <a role="menuitem" href="/logout"><i class="bx bx-power-off"></i> Çıkış</a>
                </li>
